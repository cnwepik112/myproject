...
<script type="text/javascript">
	function dialogAjaxDone(response) {
		...
		navTab.reload("<%=request.getContextPath()%>/attendance/getAllAudit", "");
	}
</script>
<body>
	<div class="pageContent">
		<form method="post" action="<%=request.getContextPath()%>/audit/addAudit" class="pageForm required-validate" onsubmit="return validateCallback(this, dialogAjaxDone)">
