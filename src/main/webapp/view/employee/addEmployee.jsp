...
<script type="text/javascript">
	function dialogAjaxDone(response) {
		...
		navTab.reload("<%=request.getContextPath()%>/employee/getAllEmployee", "");
	}
</script>
<body>
	<div class="pageContent">
		<form method="post" action="<%=request.getContextPath()%>/employee/addEmployee" class="pageForm required-validate" onsubmit="return validateCallback(this, dialogAjaxDone)">
