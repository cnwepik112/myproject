...
function _48fa(_48fa1){
	
	if (_48fa1.validType) {
		if ($.isArray(_48fa1.validType)) {
			for ( var i = 0; i < _48fa1.validType.length; i++) {
				if (!_491(_48fa1.validType[i])) {
					return false;
				}
			}
		} else {
			if (typeof _48fa1.validType == "string") {
				if (!_491(_48fa1.validType)) {
					return false;
				}
			} else {
				for ( var _498 in _48fa1.validType) {
					var _499 = _48fa1.validType[_498];
					if (!_491(_498, _499)) {
						return false;
					}
				}
...
//_47e(_48c);
//var _48fvT=_48fa(opts);
if(opts.required && box.val()==""){
	_481(_48c);
}else{
	_47e(_48c);	
}
...
$.fn.validatebox.defaults={required:false,validType:null,validParams:null,delay:200,missingMessage:"This field is required.",invalidMessage:null,tipPosition:"bottom",deltaX:0,novalidate:false,events:{focus:_477,blur:_47b,mouseenter:_47f,mouseleave:_482,click:function(e){
var t=$(e.data.target);
if(!t.is(":focus")){
t.trigger("focus");
}
